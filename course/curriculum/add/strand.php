...
<body>
    ...
    <nav>
        <ul>
            <li><a href="../../../home.php">Home</a> > <a href="../../?cid=<?php echo $course_id; ?>"><?php echo $course_code; ?></a> > <a href="../?cid=<?php echo $course_id; ?>">Curriculum</a> > <a href="./?cid=<?php echo $course_id; ?>">Add</a> > Strand...</li>
