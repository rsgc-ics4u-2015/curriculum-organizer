    ...
    <main>
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            <fieldset>
                ...
                <label>
                    <p>Title:</p>
                    <input type="text" name="title" value="<?php echo $_POST['title'] ?>" maxlength="255" size="82">
                    <p class="error"><?php echo $message['title']; ?></p>
                </label>                    
                <label>
                    <p>Description:</p>
                    <textarea name="description" cols="80" rows="8" maxlength="500"><?php echo $_POST['description'] ?></textarea>
